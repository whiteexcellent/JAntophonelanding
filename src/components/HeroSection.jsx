...
<div className="absolute inset-0 -z-10 flex items-center justify-center opacity-60 dark:opacity-40 overflow-hidden mix-blend-multiply dark:mix-blend-screen">
        <div className="pointer-events-none h-[650px] w-[650px] md:h-[1000px] md:w-[1000px]">
          <Globe 
            dark={isDarkMode ? 1 : 0} 
            baseColor={isDarkMode ? [0.4, 0.65, 1] : [0.1, 0.4, 1]}
            glowColor={isDarkMode ? [0.27, 0.57, 0.9] : [0.8, 0.8, 0.8]}
          />
        </div>
      </div>
