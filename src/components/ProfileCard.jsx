...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0) 100%)';
  ...
  return (
    <div
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          className="grid relative overflow-hidden bg-slate-50 dark:bg-black/90 shadow-[rgba(0,0,0,0.2)_calc((var(--pointer-from-left)*10px)-3px)_calc((var(--pointer-from-top)*20px)-6px)_20px_-5px] dark:shadow-[rgba(0,0,0,0.8)_calc((var(--pointer-from-left)*10px)-3px)_calc((var(--pointer-from-top)*20px)-6px)_20px_-5px]"
          style={{
            height: '80svh',
            maxHeight: '620px',
            aspectRatio: '0.62',
          ...
          <div
            ...
            <div
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between backdrop-blur-[30px] border border-white/20 hover:border-white/40 pointer-events-auto"
                  style={
                    {
                      '--ui-inset': '20px',
                      '--ui-radius-bias': '6px',
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-white/20 hover:border-white/40 flex-shrink-0"
                  ...
                  <button
                    className="border border-white/20 hover:border-white/40 rounded-lg px-4 py-3 text-xs font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-black/30 dark:hover:border-white/40 hover:-translate-y-px"
            ...
            <div
              ...
              <div
                ...
                <p
                  className="font-semibold whitespace-nowrap mx-auto w-min text-white/70"
                  style={{
                    position: 'relative',
                    top: '-12px',
                    fontSize: '16px',
